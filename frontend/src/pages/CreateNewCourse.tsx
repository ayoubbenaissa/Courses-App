            ...
            <div className="create-update-course">
                ...
                <div className="course-form">
                    <div className="course-field">
                        ...
                        <input minLength={1} className="course-field_content" type="text" onChange={e => {setCourseName(e.target.value)}} />
                    </div>
                    <div className="course-field">
                        <div className="course-field_name">Course Members</div>
                        {courseMembers.map((courseMember, index) => <input minLength={1} key={index} className="course-field_content" type="text" onChange={e => {
                            setTimeout(() => {
                    ...
                    <div className="course-field">
                        ...
                        <input minLength={1} className="course-field_content" type="text" onChange={e => {setCourseCoach(e.target.value)}} />
                    </div>
                    <div className="course-field">
